      ...
      <div className="border rounded-lg p-4 shadow-md w-full max-w-md">
        ...
        {cart.length > 0 && (
          <>
            ...
            <button
              onClick={checkout}
              className="mt-4 px-4 py-2 bg-green-500 text-white hover:bg-green-600 rounded focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 w-full"
            >
              Buy Now
            </button>
          </>
