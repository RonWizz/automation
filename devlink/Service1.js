...
import _styles from "./Service1.module.css";
...
export function Service1({ as: _Component = _Builtin.Block }) {
  _interactions.useInteractions(_interactionsData, _styles);

  return (
    <_Component
      className={_utils.cx(_styles, "section_services_1_header")}
      tag="header"
    >
        <_Builtin.NavbarWrapper
          className={_utils.cx(_styles, "navbar1_component")}
          data-w-id="ff6b4ea9-ded0-8f36-a4c1-3a1272b8ae1c"
          tag="div"
        ...
        <_Builtin.Block
        className={_utils.cx(_styles, "padding-global", "mobland")}
        tag="div"
      >
        <_Builtin.Block
        ...
        >
          ...
          >
            <_Builtin.Grid
              className={_utils.cx(_styles, "services_1_header_component")}
              tag="div"
            >
              <_Builtin.Block
                className={_utils.cx(_styles, "services_1_header_content-left")}
                id={_utils.cx(
                  _styles,
                  "w-node-ff6b4ea9-ded0-8f36-a4c1-3a1272b8ae20-72b8ae1a"
                )}
                tag="div"
              >
                <_Builtin.Block
                ...
                >
                  ...
                  />
                  <_Builtin.Heading
                    className={_utils.cx(_styles, "heading-28", "mobtext")}
                    tag="h4"
                  >
                    {"OUR SERVISES"}
                  </_Builtin.Heading>
                ...
                <_Builtin.Heading
                  className={_utils.cx(_styles, "heading-27", "mob")}
                  tag="h1"
                >
                  <_Builtin.Emphasized
                    className={_utils.cx(
                ...
                <_Builtin.Paragraph
                  className={_utils.cx(_styles, "paragraph-13", "mob")}
                >
                  {
              ...
              <_Builtin.Block
                className={_utils.cx(
                  _styles,
                  "services_1_header_content-right"
                )}
                tag="div"
              />
            </_Builtin.Grid>
